...
const Projects = () => {
  ...
  return <motion.section
    ...
    className="min-h-[80vh] flex flex-col py-12 xl:px-0 justify-center"
  >
            ...
            <div className="flex gap-4 items-center">
              <Link href={project.live}>
                <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    <TooltipTrigger className="w-[70px] h-[70px] flex justify-center items-center group rounded-full bg-white/5">
